...
namespace ThColumnInfo.Validate
{
    ...
    public class AngularReinforcementDiaRule : IRule
    {
        ...
        {
            if (angularReinforcementDiaModel == null || !angularReinforcementDiaModel.ValidateProperty())
            {
                return;
            }          
            ...
            {
                ValidateResults.Add("角筋直径不满足双偏压验算限值要求 ["+ angularReinforcementDiaModel.AngularReinforcementDia+
                    " < "+ angularReinforcementDiaModel.AngularReinforcementDiaLimited+"]");
            }
            else
            {
