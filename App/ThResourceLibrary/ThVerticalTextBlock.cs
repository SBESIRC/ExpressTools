...
{
    public class ThVerticalTextBlock : Control
    {
        public ThVerticalTextBlock()
        {
            IsTabStop = false;
            var templateXaml =
@"<ControlTemplate " +
...
"</ControlTemplate>";
        ...
        "Text", typeof(string), typeof(ThVerticalTextBlock), new PropertyMetadata(OnTextChanged));
        private static void OnTextChanged(DependencyObject o, DependencyPropertyChangedEventArgs e)
        {
            ((ThVerticalTextBlock)o).OnTextChanged((string)(e.NewValue));
        }
