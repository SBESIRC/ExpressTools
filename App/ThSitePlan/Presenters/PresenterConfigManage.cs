...
namespace ThSitePlan
{
    public class PresenterConfigManage : Presenter<IConfigManage>
    {
        ...
        private List<ColorGeneralDataModel> InitColorGeneral()
        {
            ...
            //string _Txt = FuncFile.ReadTxt(@"BasicStyle.txt");
            ...
            _List.Add(new ColorGeneralDataModel() { ID = "1", PID = "1", Type = "0", Name = "原始场地线稿", PSD_Color = "255, 215, 0", PSD_Transparency = 55, CAD_Frame = "原始线稿", CAD_Layer = InitLayer(), CAD_Script = "拍平闭合优化", DataType = "0" });
            ...
            _List.Add(new ColorGeneralDataModel() { ID = "4", PID = "3", Type = "0", Name = "建筑信息", PSD_Color = "135, 206, 235", PSD_Transparency = 21, CAD_Frame = "建筑信息", CAD_Layer = InitLayer(), CAD_Script = "无" });
            _List.Add(new ColorGeneralDataModel() { ID = "5", PID = "3", Type = "0", Name = "建筑线稿", PSD_Color = "50, 205, 50", PSD_Transparency = 51, CAD_Frame = "建筑线稿", CAD_Layer = InitLayer(), CAD_Script = "拍平闭合优化", DataType = "0" });
            _List.Add(new ColorGeneralDataModel() { ID = "6", PID = "3", Type = "0", Name = "建筑色块", PSD_Color = "255, 215, 0", PSD_Transparency = 100, CAD_Frame = "建筑色块", CAD_Layer = InitLayer(), CAD_Script = "线稿生成填充", DataType = "0" });
            ...
            _List.Add(new ColorGeneralDataModel() { ID = "8", PID = "7", Type = "0", Name = "建筑信息", PSD_Color = "135, 206, 235", PSD_Transparency = 100, CAD_Frame = "建筑信息", CAD_Layer = InitLayer(), CAD_Script = "无", DataType = "0" });
            _List.Add(new ColorGeneralDataModel() { ID = "9", PID = "7", Type = "0", Name = "建筑线稿", PSD_Color = "50, 205, 50", PSD_Transparency = 100, CAD_Frame = "建筑线稿", CAD_Layer = InitLayer(), CAD_Script = "拍平闭合优化", DataType = "0" });
            _List.Add(new ColorGeneralDataModel() { ID = "10", PID = "7", Type = "0", Name = "建筑色块", PSD_Color = "255, 215, 0", PSD_Transparency = 100, CAD_Frame = "建筑色块", CAD_Layer = InitLayer(), CAD_Script = "线稿生成填充", DataType = "0" });


            _List.Add(new ColorGeneralDataModel() { ID = "11", PID = "11", Type = "0", Name = "全局阴影", PSD_Color = "112, 128, 144", PSD_Transparency = 100, CAD_Frame = "全局阴影", CAD_Layer = InitLayer(), CAD_Script = "虚拟阴影", DataType = "0" });
            ...
            _List.Add(new ColorGeneralDataModel() { ID = "14", PID = "13", Type = "0", Name = "树木线稿", PSD_Color = "46, 139, 87", PSD_Transparency = 100, CAD_Frame = "树木线稿", CAD_Layer = InitLayer(), CAD_Script = "拍平闭合优化", DataType = "0" });
            _List.Add(new ColorGeneralDataModel() { ID = "15", PID = "13", Type = "0", Name = "树木色块", PSD_Color = "46, 139, 87", PSD_Transparency = 100, CAD_Frame = "树木色块", CAD_Layer = InitLayer(), CAD_Script = "线稿生成填充", DataType = "0" });
