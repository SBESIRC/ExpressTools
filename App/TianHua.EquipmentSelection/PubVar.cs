...
namespace TianHua.FanSelection
{
    public static class PubVar
    {
        public static List<FanPrefixDictDataModel> g_ListFanPrefixDict = new List<FanPrefixDictDataModel>()
        {
            ...
            new FanPrefixDictDataModel(){ No = 10, FanUse = "消防排烟兼平时排风", Prefix ="E(S)F", Explain = "包含燃烧和散热" },
            new FanPrefixDictDataModel(){ No = 11, FanUse = "消防补风兼平时送风", Prefix ="S(S)F", Explain = "包含燃烧和散热" },
