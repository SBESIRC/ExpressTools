...
namespace ThColumnInfo.Validate.Rules
{
    public class StirrupMaximumSpacingKRule : IRule
    {
        ...
        {
            if(this.smsk == null || !smsk.ValidateProperty())
            {
                return;
            }      
        ...
        public List<string> GetCalculationSteps()
        {
            ...
            steps.Add("if (抗震等级["+this.smsk.AntiSeismicGrade+"].Contains(\"特一级\") || " +
                "抗震等级["+this.smsk.AntiSeismicGrade+"].Contains(\"一级\") || " +
