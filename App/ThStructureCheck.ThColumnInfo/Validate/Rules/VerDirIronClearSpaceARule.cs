...
{
    public class VerDirIronClearSpaceARule : IRule
    {
        private VerDirIronClearSpaceModel ruleModel;
        public VerDirIronClearSpaceARule(VerDirIronClearSpaceModel ruleModel)
        {
        ...
        public void Validate()
        {
            ...
            {
                ValidateResults.Add("纵向钢筋净间距小于50mm [" + minValue + " < 50]，" + this.rule);
            }
            else if (maxValue > 300) //且不宜大于300mm
            {
                ValidateResults.Add("纵向钢筋净间距大于300mm [" + maxValue + " > 300]，" + this.rule);
            }
            else
            {
