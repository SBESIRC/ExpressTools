...
{
    public class ThCommand : ICommand
    {
        ...
        public ThCommand(Action<object> execute) : this(execute, null)
        {
        }
        ...
        public ThCommand(Action<object> execute, Func<object, bool> canExecute)
        {
            _execute = execute;
